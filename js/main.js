...
let translations = {
    ...
    ar: {
        ...
        about1: 'نفتخر بتقديم منظفات وعطور عالية الجودة مصممة لتحسين تجربتك اليومية في التنظيف. نولي اهتمامًا دقيقًا لضمان أن منتجاتنا تفي بأعلى المعايير الصناعية. سواء للاستخدام المنزلي أو الصناعي، كمتي هي العلامة التجارية الموثوقة للحلول الآمنة والصديقة للبيئة. نحن ندعم بفخر الإنتاج المحلي، ونسعى لتحسين جودة الحياة من خلال منتجات تجمع بين الأمان والكفاءة والنضارة.',
        Order: 'اطلب الآن',
        Delivery1: 'التوصيل',
